...
<body>
        ...
        <center> <ul class="navbar-nav p-2 "> 
                <li class="nav-item">
                    <h3 id="nowServingDataCashier">Now Serving </h3>
                 </li></center>
<div class="container">
        <div class="row mt-10 d-flex justify-content-center">
            <div class="center">
                <h1>Cashier Queue</h1>
                <a class="btn btn-success mb-4" href="../create2.php">Sign Up</a>
     ...
     <div class="contain">
        ...
        <span id="currentNumber">2000</span>
    ...
    <script>
         let currentNumber = 2000; // Initialize with 2000 instead of 0
...
const nowServingDataCashierSection = $('#nowServingDataCashier'); // Add this line
...
serveNowButton.addEventListener('click', () => {
    $.ajax({
        url: '../insert_data.php',
        type: 'POST',
         data: { currentNumber: currentNumber, queue: 'cashier' },
        success: function(response) {
            ...
            if (data.length > 0) {
                ...
                nowServingDataCashierSection.html(`Now Serving:<br> ${item.id}`);

                // Send the served student's ID to que.php to display in cashier's portion
                $.ajax({
                    url: 'que.php',
                    type: 'POST',
                    data: { servedId: item.id, queue: 'cashier' },
                    success: function(response) {
