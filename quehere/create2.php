...
<?php
	if ($_SERVER['REQUEST_METHOD'] == "POST") {
		...
		//$dateofofregister = $_POST['dateofofregister'];
		//$password = $_POST['password'];


		$sqlquery = "INSERT INTO cashier VALUES(null,'$fullname','$course', $contact)";
			...
			<div class="col-sm-5">
				<div class="card p-4 bg-info">
					...
					<form action="" method="POST">
						...
						<a href="tab/cashier.php" class= "btn btn-primary mt-4">Return</a>
					</form>
				</div>
			</div>
		</div>
